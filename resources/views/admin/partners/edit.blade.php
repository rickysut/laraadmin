    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.partners.update", [$partner->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('partner_type') ? 'is-invalid' : '' }}" name="partner_type" id="partner_type" required>
                    ...
                    @foreach(App\Models\Partner::PARTNER_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('partner_type', $partner->partner_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('partner_code') ? 'is-invalid' : '' }}" type="number" name="partner_code" id="partner_code" value="{{ old('partner_code', $partner->partner_code) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('partner_address') ? 'is-invalid' : '' }}" name="partner_address" id="partner_address">{{ old('partner_address', $partner->partner_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('partner_email') ? 'is-invalid' : '' }}" type="email" name="partner_email" id="partner_email" value="{{ old('partner_email', $partner->partner_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('partner_phone') ? 'is-invalid' : '' }}" type="text" name="partner_phone" id="partner_phone" value="{{ old('partner_phone', $partner->partner_phone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('partner_pic') ? 'is-invalid' : '' }}" type="text" name="partner_pic" id="partner_pic" value="{{ old('partner_pic', $partner->partner_pic) }}">
